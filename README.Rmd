...
[![CRAN status](https://www.r-pkg.org/badges/version/raretrans)](https://CRAN.R-project.org/package=raretrans)
...
> **Note:** The core functions work on any R >= 4.1.0. Vignettes require
> R >= 4.1.0 due to dependencies in `popdemo`, `dplyr`, and `purrr`.
> If you are on an older version of R, install without vignettes (see
> below) and read them online at <https://atiretoo.github.io/raretrans/>.
...
- Report bugs or request features at <https://github.com/atiretoo/raretrans/issues>
- Read the full function reference at <https://atiretoo.github.io/raretrans/reference/>
...
[Contributor Code of Conduct](https://github.com/atiretoo/raretrans/blob/master/CODE_OF_CONDUCT.md).
