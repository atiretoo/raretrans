...
| Function | Purpose |
|----|----|
| [`fill_transitions()`](https://atiretoo.github.io/raretrans/reference/fill_transitions.md) | Fill a transition matrix using a Dirichlet-multinomial prior |
| [`fill_fertility()`](https://atiretoo.github.io/raretrans/reference/fill_fertility.md) | Fill a fertility matrix using a Gamma prior |
| [`sim_transitions()`](https://atiretoo.github.io/raretrans/reference/sim_transitions.md) | Simulate posterior transition matrices |
| [`transition_CrI()`](https://atiretoo.github.io/raretrans/reference/transition_CrI.md) | Compute credible intervals for all transition probabilities |
| [`plot_transition_CrI()`](https://atiretoo.github.io/raretrans/reference/plot_transition_CrI.md) | Visualise posterior means and credible intervals |
| [`plot_transition_density()`](https://atiretoo.github.io/raretrans/reference/plot_transition_density.md) | Visualise full posterior beta densities as a matrix plot |
...
`raretrans` includes an interactive Shiny application to explore the
effects of different Bayesian priors on transition matrices dynamically.
...
| 04 | Credible intervals | [`transition_CrI()`](https://atiretoo.github.io/raretrans/reference/transition_CrI.md) and plotting with *Cypripedium calceolus* |
...
Code of
Conduct](https://atiretoo.github.io/raretrans/CODE_OF_CONDUCT.md). By
