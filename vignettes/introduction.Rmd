---
title: "Introduction to raretrans"
output:
  rmarkdown::html_vignette:
    ...
    toc_depth: 3
vignette: >
  %\VignetteIndexEntry{Introduction to raretrans}
...
Burns, J. H., Blomberg, S. P., Crone, E. E., Ehrlen, J., Knight, T. M.,
  Pichancourt, J.-B., ..., & Buckley, Y. M. (2010). Empirical tests of life-history
  evolution theory using phylogenetic analysis of plant demography. *Journal of
  Ecology*, **98**, 334–344.
...
Tremblay, R. L., Tyre, A. J., Pérez, M.-E., & Hutchings, M. J. (2021).
  Population growth estimation from count data: Bayesian inference and its use in
  conservation. *Ecological Modelling*, **451**, 109526.
